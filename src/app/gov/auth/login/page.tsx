  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const loginRequest: LoginRequest = {
        identifier: formData.province_id,
        password: formData.password,
      };

      const response = await GovernmentAPI.login(loginRequest);
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-purple-600 mb-2">MBGku</h1>
          <p className="text-sm text-gray-600 mb-6">
            Makan Bergizi Gratis - Government Portal
          </p>
        </div>
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Enter your provincial government credentials to access the admin
          portal
        </p>
      </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                This portal is for authorized provincial government officials
                only
              </p>
            </div>
          </div>
      ...
      <div className="mt-8 text-center">
        <p className="text-xs text-gray-500">
          © 2024 MBGku - Makan Bergizi Gratis Program
        </p>
      </div>
    </div>
  );
