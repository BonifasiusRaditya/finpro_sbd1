  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const loginRequest: LoginRequest = {
        identifier: formData.student_number,
        password: formData.password,
      };

      const response = await StudentAPI.login(loginRequest);
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-green-600 mb-2">MBGku</h1>
          <p className="text-sm text-gray-600 mb-6">
            Makan Bergizi Gratis - Student Portal
          </p>
        </div>
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Enter your student credentials to access your meal portal
        </p>
      </div>
