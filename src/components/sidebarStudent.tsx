          ...
          <nav className="grid items-start px-2 text-sm font-medium">
            ...
            <Link href="/student/home">
              <Button className={cn("w-full justify-start px-4 py-2 text-sm font-medium transition-colors", 
                pathname === "/student/home" ? "bg-gray-200 text-black hover:bg-gray-200": "bg-gray-50 text-gray-700 hover:bg-gray-100")}>
                Home
              </Button>
            </Link>
            <Link href="/student/qr">
              <Button className={cn("w-full justify-start px-4 py-2 text-sm font-medium transition-colors", 
                pathname === "/student/qr" ? "bg-gray-200 text-black hover:bg-gray-200": "bg-gray-50 text-gray-700 hover:bg-gray-100")}>
                Scan QR Code
              </Button>
            </Link>
          </nav>
